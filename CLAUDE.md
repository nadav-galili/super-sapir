...
RetailSkillz Analytics — a B2B SaaS retail management dashboard MVP built for pitching to Super Sapir (Israeli food retailer). Hebrew RTL interface showing real data from a Hadera branch #44 management report (Dec 2025) combined with simulated multi-branch data.
