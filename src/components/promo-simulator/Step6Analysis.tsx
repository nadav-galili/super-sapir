        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full min-h-[260px] rounded-[10px] border border-[#E7E0D8] bg-white p-4 text-[16px] text-[#2D3748] shadow-sm transition-colors hover:bg-[#FAF8F5] focus:outline-none focus:ring-2 focus:ring-[#DC4E59]/20 focus:border-[#DC4E59]/40 leading-relaxed resize-y"
            />
          </div>
        </div>
      </CardContent>
