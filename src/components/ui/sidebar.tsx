  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper flex min-h-svh w-full overflow-x-hidden",
          props.className
        )}
        {...props}
      >
...
export function SidebarGroup({
  ...
  return (
    <div
      data-sidebar="group"
      className={cn(
        "relative flex w-full min-w-0 flex-col py-2 px-2",
        className
      )}
      {...props}
    />
...
export function SidebarMenuButton({
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex w-full items-center gap-3.5 rounded-[10px] px-3 py-2.5 text-right font-medium outline-none transition-colors",
        variant === "category" ? "text-[15px]" : "text-base",
        isActive
          ? variant === "category"
            ? "bg-[#DC4E59]/8 text-[#DC4E59] font-bold border border-[#DC4E59]/15"
            : "bg-[#DC4E59]/8 text-[#DC4E59] font-semibold"
...
export function SidebarSeparator({
  ...
  return (
    <Separator className={cn("mx-3 bg-warm-separator", className)} {...props} />
  );
}
