      ...
      <CardContent className="p-4 sm:p-5">
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="min-w-0">
            <h3 className="text-xl font-bold text-[#2D3748] truncate">{promotion.name}</h3>
            <p className="text-lg text-[#4A5568] truncate">{promotion.productName}</p>
            <div className="flex gap-2 mt-1">
              <Badge variant="outline" className="text-[16px] border-warm-border">
                {promotion.promoType}
              </Badge>
              <Badge variant="outline" className="text-[16px] border-warm-border">
            ...
            <div dir="ltr" className="h-[220px]">
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                  ...
                  <XAxis dataKey="day" tick={{ fontSize: 18 }} />
                  <YAxis
