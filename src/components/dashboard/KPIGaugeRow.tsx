  ...
  return (
    <div className="relative" style={{ width: size, height: size }}>
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10">
        <span className="text-lg font-bold font-mono text-white" dir="ltr">
          {pct}%
        </span>
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <p className="text-base font-bold font-mono tabular-nums" style={{ color }} dir="ltr">
          {formattedValue}
        </p>
...
export function KPIGaugeRow({ items }: KPIGaugeRowProps) {
  return (
    ...
    >
      ...
      {/* Color legend */}
      <div className="flex items-center justify-center gap-5 mt-4 text-[11px] text-white/40">
