                ...
                {topPromos.map((promo, i) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5 text-[#4A5568]">
                      <span dir="ltr">{promo.period}</span>
                    </td>
                    <td className="px-3 py-2.5 font-mono text-[#4A5568]">
                      <span dir="ltr">
                        {formatCurrencyShort(promo.baselineSales)}
                      </span>
                    </td>
                    <td className="px-3 py-2.5 font-mono font-semibold text-[#2D3748]">
                      <span dir="ltr">
                        {formatCurrencyShort(promo.actualSales)}
                      </span>
                    </td>
                    <td className="px-3 py-2.5">
                      <span
                        className="inline-flex items-center px-2 py-0.5 rounded-[20px] bg-[#2EC4D5]/10 text-[#2EC4D5] text-base font-semibold font-mono"
                        dir="ltr"
                      >
                        +{promo.upliftPercent}%
                      </span>
                    ...
                    <td className="px-3 py-2.5">
                      <span
                        className={`inline-flex items-center px-2 py-0.5 rounded-[20px] text-base font-semibold font-mono ${
                          promo.roi > 0
                    ...
                    <td className="px-3 py-2.5">
                      {promo.hasCannibalization ? (
                        ...
                        <span className="inline-flex items-center px-2 py-0.5 rounded-[20px] bg-[#788390]/10 text-[#788390] text-base font-medium">
                          לא
                        </span>
                      )}
                    </td>
                ...
                <div key={i} className="space-y-2">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-3">
                      <span className="text-[16px] text-[#788390] w-10 text-left">
                        בסיס
                      </span>
                      <div className="flex-1 h-5 bg-[#FDF8F6] rounded-[5px] overflow-hidden">
                        <div
                          className="h-full bg-[#788390] rounded-[5px]"
                          style={{
                            width: `${(promo.baselineSales / maxSales) * 100}%`,
                          }}
                        />
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-[11px] text-[#2EC4D5] w-10 text-left font-medium">
                        בפועל
                      </span>
                      <div className="flex-1 h-5 bg-[#FDF8F6] rounded-[5px] overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${(promo.actualSales / maxSales) * 100}%`,
                          }}
                        />
                      </div>
                    </div>
