  ...
  return (
    <Link to={to}>
      <motion.div
        ...
        whileHover={{
          y: -3,
          boxShadow: "rgba(220, 78, 89, 0.08) 0px 12px 32px",
        }}
        whileTap={{ scale: 0.99 }}
      ...
      >
        {/* Top accent stripe */}
        <div
          className="absolute top-0 right-0 left-0 h-1 rounded-t-[16px]"
        ...
        <p className="text-sm text-[#788390] leading-relaxed mb-4">
          {description}
        </p>
        <div
