// Shared bar-gradient palette used by the horizontal bars in the
// store-manager overview (expense table + department bars). Keeping
// this shared means the colors stay consistent across charts.
