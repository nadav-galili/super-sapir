  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "linear-gradient(90deg, #DC4E59, #2EC4D5)" }}
      />
      ...
      <div className="p-5 flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#2D3748]">
              סניף {info.name} #{info.branchNumber}
            </h2>
            <div className="flex items-center gap-3 mt-0.5 text-sm text-[#788390]">
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          <div
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-[20px] text-white"
            style={{ background: "linear-gradient(135deg, #DC4E59, #E8777F)" }}
          >
          ...
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-[20px] bg-[#FDF8F6] border border-warm-border text-[#4A5568]">
            ...
            <span className="text-sm" dir="ltr">
              {info.sellingArea.toLocaleString()} מ"ר
            </span>
          </div>
        </div>
      </div>
