...
תתי-פעולות (subActions, אופציונלי):
- כאשר recommendation מורכב ממספר צעדים נפרדים, פרק אותם למערך "subActions" — רשימה של מחרוזות קצרות.
- כאשר ההמלצה היא פעולה אחת רציפה, השמט את השדה לחלוטין (אל תחזיר מערך ריק).
- מותר על כל subject. אורך מומלץ: 2–4 פריטים.
- דוגמה (עבור "עמידה ביעדי מכירות"):
  {"type":"insight","subject":"עמידה ביעדי מכירות","recommendation":"להעמיק פעילות תחרותית במחלקת חלב","status":"yellow","subActions":["פרסום בסביבת החנות","העמקת הנחות במוצרי משיכה","מבצעי סל"]}
...
אוצר מילים קנוני (יש להשתמש בו בכל הפלט):
- העדף "פחת" על פני "בזבוז" בהקשר של אובדן קמעונאי
- העדף "חריגות" על פני "סטיות" בהקשר של חריגה מיעד KPI
- העדף את המילה "למול" על פני "לעומת"
- במקום לדבר על "עלות שכר" כמספר גולמי, נסח כ-"הוצאות שכר בשיעור של X% מהמחזור"`;
