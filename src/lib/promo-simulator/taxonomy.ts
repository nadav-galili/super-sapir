  ...
  "משיכת קונים": [
    {
      name: "מבצעי הוזלה",
      stars: 3,
      reason: "מחיר חד יוצר טריגר כניסה ויוצר הרגשת הזדמנות.",
      score: 92,
    },
    {
      name: "מוצר עוגן (Loss Leader)",
      stars: 3,
      reason: "מחיר אגרסיבי על מוצר עוגן גורר סל נוסף.",
      score: 88,
    },
    {
      name: "קופונים דיגיטליים",
      stars: 2,
      reason: "כלי ממוקד לקהלים רלוונטיים עם הנעה ברורה.",
      score: 78,
    },
    {
      name: "הטבת רישום / מועדון",
      stars: 2,
      reason: "מייצר מאגר לקוחות ונתוני קמפיין עתידי.",
      score: 74,
    },
  ],
  "הגדלת סל": [
    {
      name: "מארזים (Multi-Pack)",
      stars: 3,
      reason: "מחבר כמות לתמורה — הדרך הישירה להעלות סל.",
      score: 90,
    },
    {
      name: "הטבה לסל (בקניית X)",
      stars: 3,
      reason: "מעודד הוספת מוצרים משלימים לעסקה.",
      score: 89,
    },
    {
      name: "מצטברים / Loyalty Bundle",
      stars: 2,
      reason: "מעודד צבירה ומעלה תדירות קניה.",
      score: 80,
    },
    {
      name: "Cross-Sell ממוקד",
      stars: 2,
      reason: "מעלה ערך עסקה דרך מוצר משלים.",
      score: 78,
    },
  ],
  "קניה חוזרת / נאמנות": [
    {
      name: "קופון לרכישה הבאה",
      stars: 3,
      reason: "מייצר ודאות לביקור חוזר בטווח הקרוב.",
      score: 91,
    },
    {
      name: "מועדון / נקודות",
      stars: 3,
      reason: "בונה נאמנות לטווח ארוך ומייצר דאטה.",
      score: 87,
    },
    {
      name: "מארזי המשכיות",
      stars: 2,
      reason: "מעודד צריכה שוטפת של אותה המותג.",
      score: 76,
    },
  ],
  "סטוק / מלאי": [
    {
      name: "מבצעי הוזלה",
      stars: 3,
      reason: "הדרך המהירה והישירה ביותר לפינוי מלאי.",
      score: 93,
    },
    {
      name: "מארזים מהירים",
      stars: 2,
      reason: "מעלה כמות ליחידת זמן ומפנה מלאי.",
      score: 81,
    },
    {
      name: "Clearance / סוף עונה",
      stars: 2,
      reason: "תחת באנר ברור של פינוי מלאי.",
      score: 79,
    },
  ],
  "אחר / חוצה קטגוריות": [
    ...
    },
    {
      name: "חבילה עונתית",
      stars: 2,
      reason: "נקשר לנושא מוכר — חגים, עונות, אירועים.",
      score: 78,
    },
    {
      name: "Theme Event",
      stars: 2,
      reason: "מבצע סביב נושא אחיד לאורך שבוע-שבועיים.",
      score: 73,
    },
  ],
};
...
// src/data/mock-taxonomy.ts at runtime. The type is an open string because
// the set is large, localized (Hebrew), and driven by data rather than a
// closed union.
...
// The 8 wizard steps (in order). Step 5 (תרחישים ונקודת איזון) was merged
// into step 4 as additional tabs; subsequent steps were renumbered down by 1.
export const STEPS = [
  { id: 1, title: "רקע / בריף" },
