...
const items: ChainItem[] = [
  { id: 'item-01', nameHe: 'חלב תנובה 3% 1 ליטר', categoryId: 'dairy', imageUrl: 'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=120&h=120&fit=crop', monthlySales: 482_000, lastYearMonthlySales: 445_000, stockoutDays: 2, estimatedProfitLoss: 28_500, grossMarginPercent: 22.4, promoSales: 189_000, promoUpliftPercent: 64.2 },
  ...
  { id: 'item-03', nameHe: 'ביצים L חופש 12 יח׳', categoryId: 'grocery', imageUrl: 'https://images.unsplash.com/photo-1506976785307-8732e854ad03?w=120&h=120&fit=crop', monthlySales: 412_000, lastYearMonthlySales: 389_000, stockoutDays: 3, estimatedProfitLoss: 45_200, grossMarginPercent: 18.6, promoSales: 142_000, promoUpliftPercent: 52.1 },
  ...
  { id: 'item-05', nameHe: 'קוקה קולה 1.5 ליטר', categoryId: 'drinks', imageUrl: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=120&h=120&fit=crop', monthlySales: 524_000, lastYearMonthlySales: 498_000, stockoutDays: 0, estimatedProfitLoss: 0, grossMarginPercent: 24.8, promoSales: 168_000, promoUpliftPercent: 47.5 },
  { id: 'item-06', nameHe: 'שוקולד פרה 100 גר׳', categoryId: 'grocery', imageUrl: 'https://images.unsplash.com/photo-1549007994-cb92caebd54b?w=120&h=120&fit=crop', monthlySales: 298_000, lastYearMonthlySales: 275_000, stockoutDays: 1, estimatedProfitLoss: 15_600, grossMarginPercent: 32.1, promoSales: 156_000, promoUpliftPercent: 71.8 },
  ...
  { id: 'item-10', nameHe: 'נייר טואלט לילי 32 גלילים', categoryId: 'home-products', imageUrl: 'https://images.unsplash.com/photo-1584556812952-905ffd0c611a?w=120&h=120&fit=crop', monthlySales: 345_000, lastYearMonthlySales: 312_000, stockoutDays: 3, estimatedProfitLoss: 38_700, grossMarginPercent: 21.4, promoSales: 198_000, promoUpliftPercent: 82.3 },
  ...
  { id: 'item-15', nameHe: 'קפה עלית 200 גר׳', categoryId: 'grocery', imageUrl: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=120&h=120&fit=crop', monthlySales: 267_000, lastYearMonthlySales: 242_000, stockoutDays: 2, estimatedProfitLoss: 31_200, grossMarginPercent: 33.8, promoSales: 174_000, promoUpliftPercent: 68.5 },
