...
export const haderaFullReport: BranchFullReport = {
  ...
  hr: {
    ...
    salaryExpense: {
      current: 831_947,
      monthlyAvg2025: 813_971,
      monthlyAvg2024: 760_722,
    },
    salaryPercentOfRevenue: {
      current: 8.4,
      target: 7.5,
      threeYearAvg: [8.4, 7.6, 7.4],
    },
    staffing: [
  ...
  departments: [
    // טרי (Fresh) — lower inventory days (perishable)
    {
      ...
      name: "ירקות",
      category: "fresh",
      currentMonth: 1_445_717,
      yearToDate: 1_505_767,
      yoyChangePercent: 4.2,
      sharePercent: 15.4,
      targetSharePercent: 16.0,
      shareChangePercent: -1.3,
      avgDaysOfInventory: 4,
    },
    {
      id: "fresh-meat",
      name: "בשר טרי",
      category: "fresh",
      currentMonth: 229_475,
      yearToDate: 180_313,
      yoyChangePercent: -21.4,
      sharePercent: 2.4,
      targetSharePercent: 2.7,
      shareChangePercent: -25.6,
    ...
    },
    {
      ...
      currentMonth: 71_680,
      yearToDate: 77_330,
      yoyChangePercent: 7.9,
      sharePercent: 0.8,
      targetSharePercent: 0.8,
      shareChangePercent: 2.2,
      avgDaysOfInventory: 2,
    },
    {
      id: "deli",
      name: "גבינת מעדניה",
      category: "fresh",
      currentMonth: 138_891,
      yearToDate: 129_129,
      yoyChangePercent: -7.0,
      sharePercent: 1.5,
      targetSharePercent: 1.5,
      shareChangePercent: -11.9,
      avgDaysOfInventory: 5,
    },
    {
      id: "pastries",
      name: "מאפים",
      category: "fresh",
      currentMonth: 139_603,
      yearToDate: 142_634,
      yoyChangePercent: 2.2,
      sharePercent: 1.5,
      targetSharePercent: 1.5,
      shareChangePercent: -3.2,
      avgDaysOfInventory: 2,
    },
    // מזון (Food) — mid-range
    {
      ...
      name: "לחם ומאפים",
      category: "food",
      currentMonth: 204_117,
      yearToDate: 233_962,
      yoyChangePercent: 14.6,
      sharePercent: 2.2,
      targetSharePercent: 2.4,
      shareChangePercent: 8.6,
      avgDaysOfInventory: 3,
    },
    {
      id: "grocery",
      name: "מכולת",
      category: "food",
      currentMonth: 2_026_339,
      yearToDate: 2_103_981,
      yoyChangePercent: 3.8,
      sharePercent: 21.6,
      targetSharePercent: 21.3,
      shareChangePercent: -1.6,
      avgDaysOfInventory: 18,
    },
    {
      id: "drinks",
      name: "שתיה",
      category: "food",
      currentMonth: 878_077,
      yearToDate: 939_201,
      yoyChangePercent: 7.0,
      sharePercent: 9.4,
      targetSharePercent: 9.5,
      shareChangePercent: 1.3,
      avgDaysOfInventory: 21,
    },
    {
      id: "frozen",
      name: "קפואים",
      category: "food",
      currentMonth: 856_002,
      yearToDate: 870_403,
      yoyChangePercent: 1.7,
      sharePercent: 9.1,
      targetSharePercent: 8.8,
      shareChangePercent: -3.7,
      avgDaysOfInventory: 25,
    },
    {
      id: "dairy",
      name: "מוצרי חלב",
      category: "food",
      currentMonth: 1_325_976,
      yearToDate: 1_479_980,
      yoyChangePercent: 11.6,
      sharePercent: 14.1,
      targetSharePercent: 14.9,
      shareChangePercent: 5.7,
    ...
    },
    {
      ...
      sharePercent: 0.9,
      targetSharePercent: 0.9,
      shareChangePercent: -2.3,
      avgDaysOfInventory: 15,
    },
    // נון-פוד (Non-Food) — higher inventory days
    {
      ...
      name: "נון-פוד",
      category: "nonfood",
      currentMonth: 962_978,
      yearToDate: 1_007_346,
      yoyChangePercent: 4.6,
      sharePercent: 10.3,
      targetSharePercent: 10.2,
      shareChangePercent: -0.9,
      avgDaysOfInventory: 28,
    },
    {
      id: "household",
      name: "מוצרים לבית",
      category: "nonfood",
      currentMonth: 330_683,
      yearToDate: 537_273,
      yoyChangePercent: 62.5,
      sharePercent: 3.5,
      targetSharePercent: 5.4,
      shareChangePercent: 53.9,
      avgDaysOfInventory: 32,
    },
    {
      id: "baby",
      name: "תינוקות",
      category: "nonfood",
      currentMonth: 163_196,
      yearToDate: 198_797,
      yoyChangePercent: 21.8,
      sharePercent: 1.7,
      targetSharePercent: 2.0,
      shareChangePercent: 15.4,
      avgDaysOfInventory: 30,
    },
  ],
  ...
  monthly: [
    {
      month: MONTHS_HE[0],
      monthNum: 1,
      currentSales: 9_069_933,
      lastYearSales: 9_940_043,
      yoyChange: -8.8,
      businessDaysImpact: 1.5,
      salaryCostPercent: 8.4,
      supplyRate: 90,
      shopperUsage: 25,
      qualityScore: 82,
      freshQualityScore: 99,
      focusReports: 8,
      customerComplaints: 4,
      meatWastePercent: 3.1,
    },
    {
      month: MONTHS_HE[1],
      monthNum: 2,
      currentSales: 8_178_761,
      lastYearSales: 9_246_983,
      yoyChange: -11.6,
      businessDaysImpact: -5.5,
      salaryCostPercent: 9.1,
      supplyRate: 91,
      shopperUsage: 29,
      qualityScore: 82,
      freshQualityScore: 100,
      focusReports: 17,
      customerComplaints: 2,
      meatWastePercent: 2.5,
    },
    {
      month: MONTHS_HE[2],
      monthNum: 3,
      currentSales: 9_389_274,
      lastYearSales: 9_068_076,
      yoyChange: 3.5,
      businessDaysImpact: 4.0,
      salaryCostPercent: 8.8,
      supplyRate: 91,
      shopperUsage: 30,
      qualityScore: 65,
      freshQualityScore: 59,
      focusReports: 9,
      customerComplaints: 1,
      meatWastePercent: 10.3,
    },
    {
      month: MONTHS_HE[3],
      monthNum: 4,
      currentSales: 11_168_947,
      lastYearSales: 11_476_140,
      yoyChange: -2.7,
      businessDaysImpact: 4.0,
      salaryCostPercent: 7.4,
      supplyRate: 90,
      shopperUsage: 32,
      qualityScore: 76,
      freshQualityScore: 100,
      focusReports: 9,
      customerComplaints: 2,
      meatWastePercent: 4.2,
    },
    {
      month: MONTHS_HE[4],
      monthNum: 5,
      currentSales: 10_109_075,
      lastYearSales: 10_975_714,
      yoyChange: -7.9,
      businessDaysImpact: -5.0,
      salaryCostPercent: 7.9,
      supplyRate: 92,
      shopperUsage: 33,
      qualityScore: 74,
      freshQualityScore: 99,
      ...
      meatWastePercent: 5.4,
    },
    {
      month: MONTHS_HE[5],
      monthNum: 6,
      currentSales: 9_606_749,
      lastYearSales: 9_630_847,
      yoyChange: -0.3,
      businessDaysImpact: 3.0,
      salaryCostPercent: 8.8,
      supplyRate: 93,
      shopperUsage: 35,
      qualityScore: 75,
      ...
      focusReports: 4,
      customerComplaints: 2,
      meatWastePercent: 5.3,
    },
    {
      month: MONTHS_HE[6],
      monthNum: 7,
      currentSales: 10_143_356,
      lastYearSales: 10_227_348,
      yoyChange: -0.8,
      businessDaysImpact: 3.0,
      salaryCostPercent: 8.1,
      supplyRate: 95,
      shopperUsage: 35,
      qualityScore: 73,
      freshQualityScore: 68,
      focusReports: 5,
      customerComplaints: 3,
      meatWastePercent: 4.4,
    },
    {
      month: MONTHS_HE[7],
      monthNum: 8,
      currentSales: 9_850_473,
      lastYearSales: 10_160_752,
      yoyChange: -3.1,
      businessDaysImpact: -3.0,
      salaryCostPercent: 8.3,
      supplyRate: 94,
      shopperUsage: 35,
      qualityScore: 70,
      freshQualityScore: 100,
      ...
      meatWastePercent: 4.9,
    },
    {
      month: MONTHS_HE[8],
      monthNum: 9,
      currentSales: 11_241_167,
      lastYearSales: 11_199_542,
      yoyChange: 0.4,
      businessDaysImpact: -4.0,
      salaryCostPercent: 7.6,
      supplyRate: 96,
      shopperUsage: 35,
      qualityScore: 82,
      freshQualityScore: 97,
      focusReports: 1,
      customerComplaints: 1,
      meatWastePercent: 0.0,
    },
    {
      month: MONTHS_HE[9],
      monthNum: 10,
      currentSales: 10_135_494,
      lastYearSales: 9_784_099,
      yoyChange: 3.6,
      businessDaysImpact: -1.0,
      salaryCostPercent: 8.5,
      supplyRate: 96,
      shopperUsage: 35,
      qualityScore: 85,
      freshQualityScore: 100,
      focusReports: 6,
      customerComplaints: 1,
      meatWastePercent: 9.5,
    },
    {
      month: MONTHS_HE[10],
      monthNum: 11,
      currentSales: 8_862_436,
      lastYearSales: 9_000_718,
      yoyChange: -1.5,
      businessDaysImpact: -0.5,
      salaryCostPercent: 8.8,
      supplyRate: 95,
      shopperUsage: 35,
      qualityScore: 90,
      freshQualityScore: 101,
      focusReports: 3,
    ...
    },
    {
      month: MONTHS_HE[11],
      monthNum: 12,
      currentSales: 9_903_162,
      lastYearSales: 9_356_118,
      yoyChange: 5.8,
      businessDaysImpact: 3.0,
      salaryCostPercent: 8.4,
      supplyRate: 96,
  ...
  expenses: [
    {
      name: "שכר",
      currentMonth: 831_947,
      monthlyAvg2025: 813_971,
      monthlyAvg2024: 742_000,
      percentOfRevenue: 5.6,
    },
    {
      name: "שכ״ד, ארנונה וניהול",
      currentMonth: 532_000,
      monthlyAvg2025: 532_000,
      monthlyAvg2024: 506_867,
      percentOfRevenue: 3.6,
    },
    {
      name: "חשמל",
      currentMonth: 72_609,
      monthlyAvg2025: 90_449,
      monthlyAvg2024: 44_273,
      percentOfRevenue: 0.6,
    },
    {
      name: "שונות",
      currentMonth: 40_728,
      monthlyAvg2025: 46_489,
      monthlyAvg2024: 40_728,
      percentOfRevenue: 0.3,
    },
    {
      name: "אחזקה",
      currentMonth: 27_163,
      monthlyAvg2025: 25_522,
      monthlyAvg2024: 27_163,
      percentOfRevenue: 0.2,
    },
    {
      name: "נלוות לשכר",
      currentMonth: 12_386,
      monthlyAvg2025: 12_386,
      monthlyAvg2024: 12_386,
      percentOfRevenue: 0.2,
    },
    {
      name: "שמירה",
      currentMonth: 7_122,
      monthlyAvg2025: 9_712,
      monthlyAvg2024: 7_122,
      percentOfRevenue: 0.1,
    },
  ],
};
