...
const suppliers: ChainSupplier[] = [
  ...
  { id: 'sup-11', name: 'אוסם', sales: 3_980_000, targetSales: 4_100_000, grossProfitPercent: 25.6 },
  { id: 'sup-12', name: 'נסטלה ישראל', sales: 3_740_000, targetSales: 3_500_000, grossProfitPercent: 30.1 },
  { id: 'sup-13', name: 'טרה', sales: 3_510_000, targetSales: 3_800_000, grossProfitPercent: 23.4 },
  { id: 'sup-14', name: 'ברמן', sales: 3_280_000, targetSales: 3_200_000, grossProfitPercent: 19.7 },
  { id: 'sup-15', name: 'הנקל', sales: 3_050_000, targetSales: 3_300_000, grossProfitPercent: 32.8 },
  { id: 'sup-16', name: 'שופרסל פרטי', sales: 2_890_000, targetSales: 2_700_000, grossProfitPercent: 35.2 },
  { id: 'sup-17', name: 'כצט', sales: 2_640_000, targetSales: 2_900_000, grossProfitPercent: 20.5 },
  { id: 'sup-18', name: 'מאיר עזריה', sales: 2_410_000, targetSales: 2_300_000, grossProfitPercent: 26.9 },
  { id: 'sup-19', name: 'ג׳ונסון', sales: 2_180_000, targetSales: 2_400_000, grossProfitPercent: 28.3 },
  { id: 'sup-20', name: 'זוגלובק', sales: 1_960_000, targetSales: 2_100_000, grossProfitPercent: 22.1 },
  { id: 'sup-21', name: 'פריגת', sales: 1_750_000, targetSales: 1_600_000, grossProfitPercent: 34.6 },
  { id: 'sup-22', name: 'ויסוצקי', sales: 1_530_000, targetSales: 1_700_000, grossProfitPercent: 29.0 },
  { id: 'sup-23', name: 'אחוה', sales: 1_320_000, targetSales: 1_250_000, grossProfitPercent: 27.4 },
  { id: 'sup-24', name: 'גלידות שטראוס', sales: 1_100_000, targetSales: 1_200_000, grossProfitPercent: 31.7 },
  { id: 'sup-25', name: 'יפאורה תבורי', sales: 980_000, targetSales: 1_050_000, grossProfitPercent: 24.8 },
]
