...
import { n as invariant, t as require_with_selector } from "./with-selector-qIq5pva-.js";
...
//#endregion
//#region node_modules/@tanstack/store/dist/esm/batch.js
function batch(fn) {
	try {
		startBatch();
		fn();
	...
	*/
	constructor(options) {
		...
		this.update = (newOptions) => {
			...
			if (!this.__store && this.latestLocation) if (this.isServer) this.__store = createServerStore(getInitialRouterState(this.latestLocation));
			else {
...
ITERATOR_CONSTRUCTOR(SYM_ITERATOR);
ASYNC_ITERATOR_CONSTRUCTOR(SYM_ASYNC_ITERATOR, PROMISE_CONSTRUCTOR);
//#endregion
...
var Match = import_react.memo(function MatchImpl({ matchId }) {
	...
	}), matchState.parentRouteId === "__root__" && router.options.scrollRestoration ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(OnRendered, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollRestoration$1, {})] }) : null] });
});
function OnRendered() {
	const router = useRouter();
